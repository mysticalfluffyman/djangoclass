...
class UserRegistrationView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            user.save()
            message_subject = "Activate your acount"
            ...
            email.send()
            activation_msg = "Open your email to activate you accout."
            return render(
                request,"accounts/activation_email.html",{"activation_msg": activation_msg}
            )
        template_name = "accounts/signup.html"
        return render(request,template_name, {"form":form})
